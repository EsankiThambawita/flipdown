...
var FlipDown = (function () {
  ...
  function a(b) {
    ...
    "object" === _typeof(c) && ((d = c), (c = "flipdown")),
      ...
      // Adjust the initial countdown values here
    var initialDays = 1;
    var initialHours = 23;
    var initialMinutes = 55;
    var initialSeconds = 5;

    // Calculate the epoch timestamp based on the initial values
    this.epoch = this._getTime() + (initialDays * 86400) + (initialHours * 3600) + (initialMinutes * 60) + initialSeconds;
